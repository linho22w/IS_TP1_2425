...
LOG_FILE = os.path.join(LOG_DIR, "TP1_sikulix_log.txt")
#################################
...
# Configurações
# Seleção interativa da região de captura
popup("Por favor, selecione a regiao da consola onde estao os dados a capturar")
console_region = selectRegion("Selecione a região da consola")
if console_region is None:
    popup("Nenhuma região selecionada - o script será encerrado")
    exit()

write_log("Região selecionada: " + str(console_region))
API_HOST = "127.0.0.1"
API_PORT = 5077
